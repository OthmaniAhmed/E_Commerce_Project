...
<html lang="en">
    ...
    <nav id="sidebar" class="active">
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        ...
        <tbody>
            ...
            <tr>
                <td>photo :</td>
                <td><input type="text" name="photo" placeholder="nom de la photo avec extension" required> </td> 
            </tr>
            <tr>
                <td>descption  :</td>
  ...
  <?php
    ...
    if(isset($_POST['submit'])){
      ...
      $res=$r->add_article($libelle,$quantite,$prix,$description,$image_path,$gamme_id) ;
